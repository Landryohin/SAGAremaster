 ...
 */
class getDirectionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DirectionsRepository' shared autowired service.
     *
     * @return \App\Repository\DirectionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DirectionsRepository.php';

        return $container->privates['App\\Repository\\DirectionsRepository'] = new \App\Repository\DirectionsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
