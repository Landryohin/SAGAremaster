 ...
 */
class getAffectationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AffectationsRepository' shared autowired service.
     *
     * @return \App\Repository\AffectationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AffectationsRepository.php';

        return $container->privates['App\\Repository\\AffectationsRepository'] = new \App\Repository\AffectationsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
