...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\AffectationsType' => ['privates', 'App\\Form\\AffectationsType', 'getAffectationsTypeService', true],
            'App\\Form\\AttacheReponseType' => ['privates', 'App\\Form\\AttacheReponseType', 'getAttacheReponseTypeService', true],
            'App\\Form\\DirectionsType' => ['privates', 'App\\Form\\DirectionsType', 'getDirectionsTypeService', true],
            'App\\Form\\DivisionsType' => ['privates', 'App\\Form\\DivisionsType', 'getDivisionsTypeService', true],
            'App\\Form\\DocumentsType' => ['privates', 'App\\Form\\DocumentsType', 'getDocumentsTypeService', true],
            'App\\Form\\InitialisedDataType' => ['privates', 'App\\Form\\InitialisedDataType', 'getInitialisedDataTypeService', true],
            'App\\Form\\PasswordAccountType' => ['privates', 'App\\Form\\PasswordAccountType', 'getPasswordAccountTypeService', true],
            'App\\Form\\PostesType' => ['privates', 'App\\Form\\PostesType', 'getPostesTypeService', true],
            'App\\Form\\SecretariatsType' => ['privates', 'App\\Form\\SecretariatsType', 'getSecretariatsTypeService', true],
            'App\\Form\\ServicesType' => ['privates', 'App\\Form\\ServicesType', 'getServicesTypeService', true],
            'App\\Form\\TypeDocumentsType' => ['privates', 'App\\Form\\TypeDocumentsType', 'getTypeDocumentsTypeService', true],
            ...
            'App\\Form\\AffectationsType' => '?',
            'App\\Form\\AttacheReponseType' => '?',
            'App\\Form\\DirectionsType' => '?',
            'App\\Form\\DivisionsType' => '?',
            'App\\Form\\DocumentsType' => '?',
            'App\\Form\\InitialisedDataType' => '?',
            'App\\Form\\PasswordAccountType' => '?',
            'App\\Form\\PostesType' => '?',
            'App\\Form\\SecretariatsType' => '?',
            'App\\Form\\ServicesType' => '?',
            'App\\Form\\TypeDocumentsType' => '?',
            'App\\Form\\UsersType' => '?',
