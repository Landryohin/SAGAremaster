 ...
 */
class getTypeDocumentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeDocumentsRepository' shared autowired service.
     *
     * @return \App\Repository\TypeDocumentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeDocumentsRepository.php';

        return $container->privates['App\\Repository\\TypeDocumentsRepository'] = new \App\Repository\TypeDocumentsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
