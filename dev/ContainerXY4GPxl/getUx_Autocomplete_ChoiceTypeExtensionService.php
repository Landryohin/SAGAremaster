...
class getUx_Autocomplete_ChoiceTypeExtensionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['ux.autocomplete.choice_type_extension'] = new \Symfony\UX\Autocomplete\Form\AutocompleteChoiceTypeExtension(($container->services['translator'] ?? self::getTranslatorService($container)));
    }
}
