 ...
 */
class getProvenancesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProvenancesRepository' shared autowired service.
     *
     * @return \App\Repository\ProvenancesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProvenancesRepository.php';

        return $container->privates['App\\Repository\\ProvenancesRepository'] = new \App\Repository\ProvenancesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
