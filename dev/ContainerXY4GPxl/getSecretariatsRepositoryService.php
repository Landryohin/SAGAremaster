 ...
 */
class getSecretariatsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SecretariatsRepository' shared autowired service.
     *
     * @return \App\Repository\SecretariatsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SecretariatsRepository.php';

        return $container->privates['App\\Repository\\SecretariatsRepository'] = new \App\Repository\SecretariatsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
